  ...
  return (
    <div className="px-8 pb-16 pt-8">
      ...
      <p className="mt-1 text-[13px] text-secondary">
        Formal Net-30 invoices generated by our team once an invoice request is processed.
      </p>

      {invoices.length === 0 ? (
        <EmptyState
          title="No invoices yet."
          hint="Once the sales team processes your invoice request, the formal invoice will appear here."
          className="mt-8"
        />
      ) : (
