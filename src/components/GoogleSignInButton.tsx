...
/**
 * Branded "Sign in with Google" — same UX pattern as hq.eelolive.com:
 * a full-width button that starts the authorization-code redirect
 * (`/api/auth/google` → Google → `/api/auth/callback/google`), not the GIS
 * One Tap iframe. Password login stays available above.
 */
  ...
  return (
    <div className="mt-6">
      <div className="mb-4 flex items-center gap-3">
        ...
        <span className="text-[11px] uppercase tracking-[0.14em] text-muted">or</span>
        <div className="h-px flex-1 bg-border" />
      </div>
